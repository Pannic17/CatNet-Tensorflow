...
def main():
    ...
    image_path = os.path.join(data_root, "data_set", "cat_data")  # flower data set path
    ...
    for epoch in range(epochs):
        ...
        if val_accuracy.result() > best_val_acc:
            ...
            model.save_weights("./save_weights/CMN_b16e24_onnx_v6.ckpt", save_format="tf")
            model.save("./save_weights/CMN_b16e24_onnx_v6", save_format='tf')
